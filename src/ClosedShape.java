...
public class ClosedShape {
	 ...
	 */
	 ...
	 /**
	  * @param shape knows what type of shape we are reading from data file.
	  */
	 ...
	 /**
	  * @return True if the shape is pulsing, otherwise false.
	  */
